...
Insert into account (user_id, balance) -- Added these inserts
Values (1001, 500),
        (1002, 1200),
        (1001, 1000);

Insert into Transfer (from_user_id, to_user_id, from_account_id, to_account_id, amt_transferred)
Values (1001, 1002, 2001, 2002, 300),
        (1001, 1002, 2003, 2002, 500),
        (1002, 1001, 2002, 2003, 100);
